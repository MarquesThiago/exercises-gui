...
class Paint():
    ...
    def save(self):
        ...
        # window -> winfo_rootx, winfo_rooty paraha o inicio da posição da tela
        # canvas -> einfo_x, winfo_y pega o posição da eixo do meu canvas 
        # canvas -> winfo_width péga o tamanho largura do canvas 
        # canvas -> winfo_height pega a altura do canvas  
